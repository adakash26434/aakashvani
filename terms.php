...
<head>
    ...
    <title><?=$t('सेवा सर्त','Terms of Service')?> | <?=$t('आकाशवाणी','Aakashvani')?><meta property="og:title" content="<?= $t('आकाशवाणी', 'Aakashvani') ?>">
        ...
        <div class="tp-container">
            <div class="tp-nav-inner">
                <button class="tp-nav-toggle" id="navToggle" aria-label="Menu"><i data-lucide="menu"></i></button>
                    ...
                    <li><a href="/" class="active"><?= $t('गृह', 'Home') ?></a></li>
    ...
    <section style="padding:var(--sp-12) 0">
        <div class="container" style="max-width:800px">
            <div class="card card-body">
                <h2 style="margin-bottom:var(--sp-4)"><?=$t('सेवाको प्रयोग','Use of Service')?></h2>
                ...
                <h2 style="margin-top:var(--sp-8);margin-bottom:var(--sp-4)"><?=$t('सामग्री','Content')?></h2>
                <p style="color:var(--dark-600);line-height:1.8">
