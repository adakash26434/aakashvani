                ...
                <div class="header-grid">
                    ...
                    <nav class="main-nav">
                        <div class="nav-list">
                            ...
                            <a href="/gov-services.php" class="nav-item-link active"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:1rem;height:1rem"><path d="M3 21h18"/><path d="M5 21V7l8-4v18"/><path d="M19 21V11l-6-4"/></svg><?=$t('सरकारी सेवा','Gov Services')?></a>
                        </div>
                    </nav>
                </div>
            </div>
