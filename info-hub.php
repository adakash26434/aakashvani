...
.hub-header { display: flex; align-items: center; gap: 12px; margin-bottom: 16px; }
.hub-header h1 { font-size: 24px; font-weight: 800; color: #0f172a; }
.hub-header p { font-size: 13px; color: #64748b; }
...
/* Mobile: Quick access 3 columns */
@media (max-width: 480px) {
  .quick-access { grid-template-columns: repeat(3, 1fr); }
  .quick-access a:nth-child(n+4) { display: none; }
